...
function Contactus() {
  ...
  return (<section id="Contactus">
        ...
        <a className="iconn" href="https://wa.me/+966566257866">
          <img class="" style={{ width: 50 }} alt="whatsapplogo" src={whtsapp1}  />
        </a>
...
<div class="col-md-6 ">
  <img style={{ borderRadius: '20px', width:"250px" ,height:"250px" }}src={last}  class="img-fluid" alt="lastimg" />
</div>

</div>
     <div class ="row text-center ">
      <h1  style={{color:"#005da7"}} data-aos="zoom-in-right">LOCATE US
        <a  style={{color:"#005da7"}} href="cstmicon"> <FontAwesomeIcon className="custom-icon" icon={faMapLocation}  bounce/></a>
      </h1>
        </div>
      <iframe class="mt-4" title="maploc" style={{ width:"100%" ,height:"450" , allowfullscreen:"1" ,loading:"lazy", referrerpolicy:"no-referrer-when-downgrade"}}  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3713.7552694658966!2d40.47360949999999!3d21.4388623!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x15ea2f7d34d78f7d%3A0xa6d814be696ba44a!2z2YXYrNmF2Lkg2KfZhNiq2KfYrCDYp9mE2LfYqNmK!5e0!3m2!1sen!2ssa!4v1738000804549!5m2!1sen!2ssa" width="600" height="450" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade">
      </iframe>
    </div>
    </section>
